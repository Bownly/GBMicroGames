...
#ifdef MICROGAME
MICROGAME(MG_TEMPLATE_FACE,         templateFaceMicrogameMain,          1U, 3U, "FACE GAME",       "BOWNLY",          " CHEER UP!")
MICROGAME(MG_BOWNLY_BOW,            bownlyBowMicrogameMain,             2U, 4U, "BOW",             "BOWNLY",          "SHOOT!")
MICROGAME(MG_BOWNLY_MAGIPANELS5,    bownlyMP5MicrogameMain,             2U, 4U, "MAGIPANELS",      "BOWNLY",          "INCREASE TO 5!")
