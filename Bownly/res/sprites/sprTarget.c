...
const palette_color_t sprTarget_palettes[4] = {
	RGB8(255, 255, 255), RGB8(251, 242, 54), RGB8(132, 126, 135), RGB8(34, 32, 52)
};

const uint8_t sprTarget_tiles[96] = {
...
const metasprite_t sprTarget_metasprite0[] = {
...
const metasprite_t* const sprTarget_metasprites[1] = {
	sprTarget_metasprite0
};
